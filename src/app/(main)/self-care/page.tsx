    ...
    <div ref={pullRef} className="px-4 pt-6 max-w-lg mx-auto relative overflow-auto">
      ...
      {loading ? (
        ...
        <Card variant="champagne" padding="lg" className="text-center">
          <SuitIcon suit="heart" size="xl" className="opacity-20 block mx-auto mb-3" />
          <p className="font-heading font-bold text-midnight">
            No self-care routines yet
          </p>
          <p className="text-sm text-muted mt-1">
            Taking care of yourself is the bravest card you can play.
            Routines will appear here once they&apos;re set up.
          </p>
        </Card>
      ) : (
        <>
